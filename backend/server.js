...
//using the routes
app.use('/exercises', exercisesRouter); // /exercises route will load everything in the exerciseRouter
app.use('/users', usersRouter) // /users route will load everything in the usersRouter
